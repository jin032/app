...
class PhoneBooksControllerTest < ActionController::TestCase
  ...
  test "should create phone_book" do
    assert_difference('PhoneBook.count') do
      post :create, phone_book: { address: @phone_book.address, name: @phone_book.name, phone_number: @phone_book.phone_number }
    end
  ...
  test "should update phone_book" do
    patch :update, id: @phone_book, phone_book: { address: @phone_book.address, name: @phone_book.name, phone_number: @phone_book.phone_number }
    assert_redirected_to phone_book_path(assigns(:phone_book))
  end
